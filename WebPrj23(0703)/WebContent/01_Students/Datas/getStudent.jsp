...
<%
	...
	while(rs.next()){
		...
		obj.put("comid1",rs.getString("COMID1")); //경남
		obj.put("comid2",rs.getString("COMID2")); //창원
		obj.put("comid3",rs.getString("COMID3")); //성산구
		obj.put("comid4",rs.getString("COMID4")); //중앙동
